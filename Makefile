...
TARGETS:=bandwhich bat bottom chafa crane dua duf dust dyff fd fzf glow heksa hexyl hyperfine jq lf mkcert ncdu nvim.appimage reg rg starship stern tmux yank xh yj zoxide
